...
function listaAtualizada(){
    let removeds = document.getElementsByClassName('removed')
    Array.from(removeds).forEach(task => task.remove())
}

const btnRemover = document.getElementById("remove").addEventListener("click", listaAtualizada)
